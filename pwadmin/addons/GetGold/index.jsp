		...
		<td align="center" valign="middle">
			<%
				if(request.getSession().getAttribute("user") != null)
				{
					...
					{
						out.print(" <font color=\"#ee0000\"><b>Disconnect from the game to purchase Gold with Coins!</b></font><br><a href=\"index.jsp\">Reload</a>");
					}
					else
					{
						int roleid = uid;
						...
						if(request.getParameter("cubi") != null)
						{
							...
							{
								out.println("<font color=\"#ff0000\"><b>Invalid Gold Amount!</b></font>");
							}
							else
							{
								...
								out.println("<font color=\"#00ee00\"><b>" + cubi_amount + " Gold Purchased<br>Transaction may take up to 5 Minutes<br>Relog Required!</b></font>");
							}
						}
						...
						out.println("<tr><td><font color=\"#000000\"><b>Price / Unit: </b></font></td><td>" + unitprice + " Coins / Gold<td></tr>");
						out.println("<form name=\"addcubi\" action=\"index.jsp?roleid=" + roleid + "\" method=\"post\">");
						out.println("<tr><td><font color=\"#000000\"><b>Purchase Gold: </b></font></td><td><input type=\"number\" name=\"cubi\" value=\"0\" min=\"0\" max=\"" + max_cubi + "\" onChange=\"javascript:updatePrice()\" style=\"width: 100%; text-align: center;\"></input><td></tr>");
