...
<%
	...
	boolean show_smiley_picture = false;
...
*/
		...
		out.print("<tr>");
		out.print("<td align=\"left\" style=\"border-bottom: 1px solid #cccccc;\">time:</td>");
		out.print("<td style=\"border-bottom: 1px solid #cccccc;\"><b><font color=\"#000000\">"+ time +"</font></b></td>");
		out.print("<td align=\"left\" style=\"border-bottom: 1px solid #cccccc;\">from:</td>");
		out.print("<td style=\"border-bottom: 1px solid #cccccc;\"><b>"+ color + sender +"</font></b></td>");
		out.print("<td align=\"left\" style=\"border-bottom: 1px solid #cccccc;\">to:</td>");
		out.print("<td style=\"border-bottom: 1px solid #cccccc;\"><b>"+ color + recipient +"</font></b></td>");
		out.print("<td align=\"left\" style=\"border-bottom: 1px solid #cccccc;\">msg:</td>");
