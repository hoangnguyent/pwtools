...
function installSeverPackages(){
    ...
    apt install -y mc nano wget curl sed bash grep locales dpkg net-tools iputils-ping > /dev/null 2>&1
...
function installDevPackages(){
    ...
    apt install -y libtask64 libpangoxft-1.0-0 libgtk2.0-0 libpcre3 libstdc++5 libxml2 libkrb5-3 libssl1.0.0 libdb4.2 gcc-multilib zlib1g libc6 libstdc++6 > /dev/null 2>&1
    apt install -y libc6:i386 libncurses5:i386 libstdc++5:i386 libstdc++6:i386 libxml2:i386 libpcre3:i386 libgtk2.0-0:i386 libpangoxft-1.0-0:i386 libpangox-1.0-0:i386 libidn11:i386 gstreamer0.10-pulseaudio:i386 gstreamer0.10-plugins-base:i386 gstreamer0.10-plugins-good:i386 gstreamer0.10-ffmpeg:i386 zlib1g:i386 > /dev/null 2>&1
...
function setupDb() {
    ...
    wget -c https://raw.githubusercontent.com/hoangnguyent/pwtools/refs/heads/master/pwa.sql -O "$DIR_WORKSPACES/pw.sql"
...
function setupIwebJava(){
    ...
    # Tomcat 7.0.108. 
    wget https://archive.apache.org/dist/tomcat/tomcat-7/v7.0.108/bin/apache-tomcat-7.0.108.tar.gz -P /tmp/$now/
    sudo tar xf /tmp/$now/apache-tomcat-7.0.108.tar.gz -C $DIR_WORKSPACES_HOME/tomcat
    rm /tmp/$now/apache-tomcat-7.0.108.tar.gz
    ...
    ./fetch --repo="https://github.com/hoangnguyent/pwtools" --ref="master" --source-path="/pwadmin" $DIR_WORKSPACES_HOME/pwadmin/webapps/pwadmin
...
function composeStartAndStopScript(){
    ...
    wget -O /start https://raw.githubusercontent.com/hoangnguyent/pwtools/refs/heads/master/start
    wget -O /stop https://raw.githubusercontent.com/hoangnguyent/pwtools/refs/heads/master/stop
...
function setupGameServer(){
    ...
    #./fetch --repo="https://github.com/hoangnguyent/pwtools" --ref="master" --source-path="/copy" /copy
    #Copy the whole folder exept /copy/etc/hosts
    #rsync -av --exclude='/hosts' /copy/etc/ /etc/
    #TODO: chỉ copy các file thiếu from outside to /lib thôi. Hình như chả cần cả 64 đâu. Hình như không cần libtask.so nào cả.
    cp -rf /copy/lib/* /lib
