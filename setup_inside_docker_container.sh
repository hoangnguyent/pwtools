...
function setupIwebJava(){
    ...
    ./fetch --repo="https://github.com/hoangnguyent/pwtools" --ref="main" --source-path="/pwadmin" "${DIR_WORKSPACES_HOME}"/pwadmin/webapps/pwadmin
